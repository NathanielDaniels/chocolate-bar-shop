...
//   return (
    ...
    >
      <defs>
        ...
        <path id="c" class="primary design" style={{ display: "none" }} />
        <path id="e" class="primary design" style={{ display: "none" }} />
        <path id="f" class="primary design" style={{ display: "none" }} />
        ...
        <mask id="j" mask-type="alpha">
          <g filter="url(#d)">
            <path fill="#fff" d="M0 0h500v500H0z" opacity="0" />
            <use xmlns:ns3="http://www.w3.org/1999/xlink" ns3:href="#e" />
          </g>
        </mask>
        <mask id="i" mask-type="alpha">
          <use xmlns:ns4="http://www.w3.org/1999/xlink" ns4:href="#f" />
        </mask>
        <clipPath id="g">
      ...
      <g clip-path="url(#g)">
        <g clip-path="url(#h)" style={{ display: "block" }}>
          ...
          <g mask="url(#j)" style={{ display: "none" }}>
            <path fill="none" class="primary design" />
          </g>
          <path
            fill="none"
            class="primary design"
        ...
        <g clip-path="url(#k)" opacity="0" style={{ display: "none" }}>
          <g
            fill="none"
            class="primary design"
            mask="url(#l)"
