...
export function FooterContainer() {
  return (
    <Footer>
      <Footer.Wrapper>
        <Footer.Logo
          src="./img/icons/chocolate-bar-pieces-blue.png"
        ...
        <Footer.Section>
          ...
          <ul>
            <li>
              <a href="/join">See What You Can Do</a>
            </li>
            <li>
              <a href="/join">Become Serious Friends</a>
            </li>
          </ul>
        </Footer.Section>
        <Footer.Section>
          ...
          <ul>
            <li>
              <a href="/chocoShop">Big Bars</a>
            </li>
            <li>
              <a href="/chocoShop">Small Bars</a>
            </li>
            <li>
              <a href="/chocoShop">Tiny Tony's</a>
            </li>
            <li>Store Locator</li>
          </ul>
        </Footer.Section>
